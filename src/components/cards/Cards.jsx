...
export const projects = [
    ...
    {id: 3, image: minigamesImg, title: "minijuegos-4EnLinea", description: "pagina de minijuegos con 4 en linea hecho en canvas con Javascript, CSS y Html", tools: ['Javascript', 'CSS', 'Html'], url: 'https://github.com/Javi3rondicol84/PaginaMinijuegos4enLinea-equipo-de-dos.'},
    {id: 4, image: spidermanImg, title: "landing page spider man", description: "landing page de spider man con animaciones", tools: ['Javascript', 'CSS', 'html'], url: 'https://github.com/Javi3rondicol84/PaginaFrontEndTematicaSpiderMan-equipo-de-dos.'},];
